...
qoin.init("b128446d-0f28-4935-a1a4-0241391a3f6f");
jQuery( function( $ ) {
					...
					success:	function( result ) {
						...
						try {
							if ( 'success' === result.result && $form.triggerHandler( 'checkout_place_order_success' ) !== false ) {
								...
								qoin.pay({
									"trxNo": result.payload.data.trxNo,
									"trxReferenceNo": result.payload.data.trxReferenceNo,
									"signature": result.payload.data.signature,
								}, {
									onSuccess: function (rs) {
										// debugger
										console.log(rs);
										console.log('success'); console.log(rs);

										if(rs){
											if(rs.url_payment){
												window.open(rs.url_payment, '_blank');
											}
